...
def process_image(img, width, height):
    ...
    if top_left_corner_x is not 999:
        paddle_x = (top_left_corner_x + bottom_right_corner_x)/2
        breakout.set_paddle_x(paddle_x, width)

    box_width = bottom_right_corner_x - top_left_corner_x 
    box_height = bottom_right_corner_y - top_left_corner_y
